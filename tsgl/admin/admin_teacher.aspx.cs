...
public partial class admin_admin_teacher : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string sqlStr = "select * from aqwj where lanmu like '%教学师资%'";
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        String sql = "delete from aqwj where id =" + id;
    ...
    protected void btn_click(object sender, EventArgs e)
    {
        ...
        SqlConnection myConn = GetConnection();
        string sql = "insert into aqwj(title,uname,pic,nr,lanmu)values";
        sql += "('" + bookname.Text + "','" + price.Text + "','" + fuUpLoad.FileName.ToString() + "','" + content.Text + "','教学师资')";
        SqlCommand cmd = new SqlCommand(sql, myConn);
        cmd.Connection.Open();
        cmd.ExecuteNonQuery();
